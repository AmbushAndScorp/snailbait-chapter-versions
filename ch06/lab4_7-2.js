var SnailBait = function () {
   ...
   this.PIXIE_CELLS_WIDTH = 32;
   this.PIXIE_CELLS_HEIGHT = 32;
   ...
   this.pixieData = [
      { left: 180, top: this.TRACK_2_BASELINE - 1.5*this.PIXIE_CELLS_HEIGHT}
   ]
...
SnailBait.prototype = {
   ...
   addSpritesToSpriteArray: function () {
      ...
      for (var i=0; i < this.pixies.length; ++i) {
         this.sprites.push(this.pixies[i]);
      }
   ...
   initializeSprites: function() {  
      ...
      this.positionSprites(this.pixies, this.pixieData);
   },
   ...
   createPixieSprites: function () {
      var pixie;
      for (var i = 0; this < this.pixieData.length; ++i) {
         pixie = new Sprite('pixie', new SpriteSheetArtist(this.spritesheet, this.pixieCells));
         pixie.width = this.pixieCells[1].width;
         pixie.height = this.PIXIE_CELLS_HEIGHT;
         this.pixies.push(pixie);
      }
   },
   ...
   */
   ...
   initializeImages: function () {
      this.spritesheet.src = 'images/lab4_7-2-spritesheet.png';
